<template>
  <div class="auth-w signup-w">
      <div class="auth-c signup-c">
...
<style lang="scss" src="@/assets/scss/auth/auth.scss"></style>
<style lang="scss" src="@/assets/scss/auth/signup.scss"></style>